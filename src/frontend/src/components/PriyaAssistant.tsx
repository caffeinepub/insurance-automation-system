...
async function callPriyaAI(
  ...
  const systemPrompt = [
    ...
    "2. STRICT RULE: If ANY user question is NOT related to motor insurance, vehicle insurance, the app workflow, or insurance industry topics, respond EXACTLY with: 'Ye motor insurance se related nahi hai, main isme madad nahi kar paungi. Kya main aapki insurance se related kisi cheez mein madad kar sakti hoon?' Do NOT answer non-insurance questions under any circumstances.",
